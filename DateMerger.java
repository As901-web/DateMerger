...
public class DateMerger {
	...
	public static void main(String[] args) throws Exception {
		...
		dateRanges.add(new DateRange(LocalDate.of(2014, 3, 10), LocalDate.of(2014, 4, 12)));
		...
		dateRanges.stream().forEach(dateRange -> System.out.println(formatter.format(dateRange.getStartDate()) + " - " + formatter.format(dateRange.getEndDate())));
		...
		mergedDateRange.stream().forEach(dateRange -> System.out.println(formatter.format(dateRange.getStartDate()) + " - " + formatter.format(dateRange.getEndDate())));
	}
